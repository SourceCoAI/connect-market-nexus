  ...
  try {
    ...
    if (!finalContactId) {
      ...
      if (newContact) {
        ...
        console.log("[invite-portal-user] Contact lookup fallback:", finalContactId ? "found" : "none");
      }
    }
    ...
    console.log(`[invite-portal-user] Successfully invited ${normalizedEmail} to portal ${portal_org_id}`);
