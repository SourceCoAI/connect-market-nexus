...
INSERT INTO valuation_leads (
  source_submission_id, full_name, email, website, created_at,
...
-- Adam Haile – auto_repair, 1 loc
(
  '0483a482-9005-4a19-8503-d47692573a81',
  'Adam Haile', 'ahaile14@gmail.com', 'sourcecodeals.com',
...
(
  ...
  'Adam Haile', 'adambhaile00@gmail.com', 'sourcecodeals.com',
...
-- Adam – specialty, 2 locs
(
  '0e0adf0b-1f67-4129-85c0-139c967d5dfa',
  'Adam', 'adambhaile00@gmail.com', 'sourcecodeals.com',
...
-- Philip Colasuonno – collision
(
  '5730c0b3-8d4a-47de-b120-921f7cd19093',
  'Philip Colasuonno', 'phijo7@aol.com', 'Merit Service Co Inc',
...
(
  ...
  'Philip Colasuonno', 'pc@pcatax.net', 'Merit Auto service co',
...
-- Bill Martin – collision
(
  'f78960b4-69cc-4757-973b-d5feeabd6433',
  'Bill Martin', 'bill.martin@sourcecodeals.com', 'sourcecodeals.com',
...
(
  ...
  'Philip Colasuonno', 'phijo7@aol.com', 'Merit Service company',
...
-- Scott Wagner – auto_repair
(
  'ff8607c9-2d6b-4560-9538-93b7b4409418',
  'Scott Wagner', 'srkw2@aol.com', 'Scott Wagner',
...
(
  ...
  'Adam Haile', 'ahaile14@gmail.com', 'myshop',
...
-- Sam – auto_repair, Vancouver BC
(
  '737d826e-1d43-43d1-b560-39b3d83c59ba',
  'Sam', 'samiam.h@hotmail.com', 'Shop',
...
-- Troy Fralick – specialty, Crawfordville FL
(
  '14ec2e76-7014-4a66-8385-0ddf700ea322',
  'Troy Fralick', 'remadebyhandinc@gmail.com', 'GKRestorations.com',
...
-- fitzroy henry – auto_repair, New York NY
(
  '670e6f92-ef5e-479c-8b02-be4e47709dd3',
  'fitzroy henry', 'fitzroy.henry@pfizer.com', 'Quality Auto',
...
-- dan ferguson – auto_repair, Las Vegas NV
(
  '091ae8a6-11d8-4046-a936-16244ee37919',
  'dan ferguson', 'fdaniel314@aol.com', 'mymechanic',
...
-- paul K – auto_repair, Homer Glen IL
(
  '4bcb5f2b-f188-4457-b197-20ed6f1ab2cd',
  'paul K', 'plkomskis@gmail.com', 'kcc',
...
-- Mark E Taylor – auto_repair, Othello WA
(
  '58fc62ec-f80d-4aaf-a603-9bc7c3e33254',
  'Mark E Taylor', 'mark.e.taylor@comcast.net', E'Dino\u2019s Auto Care',
...
-- peter hamilton – collision, Toronto ON
(
  '7186ad78-702b-477e-8173-5aac235156e8',
  'peter hamilton', 'petehamiltonautobodyandrestorations@outlook.com', 'pete hamilton autobady and restorations inc.',
...
-- RANDY HASSELL – collision, Queens NY
(
  'b21e713e-a45e-48be-be86-3aae288ba3c4',
  'RANDY HASSELL', 'hassellbros@hotmail.com', 'WWW.HASSELLBROS.COM',
...
-- Full Name (Hi-Tech Car Care) – auto_repair, Phoenix AZ
(
  'e7397a40-ab1c-4876-b583-35370c53c91e',
  'Full Name', 'info@hi-techcarcare.com', 'www.hi-techCarCare.com',
...
-- Michael Boze – auto_repair, Thousand Oaks CA
(
  '07619097-44cd-464c-bc44-a791e55148a9',
  'Michael Boze', 'mboze1956@gmail.com', 'Giant Oak Automotive',
