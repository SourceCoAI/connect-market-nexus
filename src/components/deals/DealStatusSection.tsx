...
function getStageExplanation(
  ...
  return 'Your interest is being reviewed by our team. Once approved, your interest will be presented to the owner and our team will follow up with next steps. Expect to hear from us within 1-2 business days.';
}
