...
const DEAL_EXPORT_COLUMNS: { key: string; label: string }[] = [
  ...
  { key: "main_contact_linkedin_url", label: "Contact LinkedIn URL" },
  { key: "main_contact_mobile_phone_1", label: "Contact Mobile Phone 1" },
  { key: "main_contact_mobile_phone_2", label: "Contact Mobile Phone 2" },
  { key: "main_contact_mobile_phone_3", label: "Contact Mobile Phone 3" },
  { key: "main_contact_office_phone", label: "Contact Office Phone" },
