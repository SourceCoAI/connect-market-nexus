// ── Core domain types ────────────────────────────────────────────────
// This barrel file is the single import point for shared application types.
...
/** JSON-compatible value (mirrors Supabase Json type). */
...
/** Generic async operation result wrapper. */
...
/** Metadata record that avoids bare `any`. */
