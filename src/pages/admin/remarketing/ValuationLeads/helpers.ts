...
export const WORD_DICT = new Set([
  ...
  "management", "consulting", "roofing", "plumbing",
  "electric", "heating", "cooling", "hvac",
  ...
  "digital", "media", "web", "net", "online",
  "cloud", "data", "soft", "ware", "software", "system",
  ...
  "hoppah", "clearpay", "globall", "bilingual",
  "restorations",
]);
